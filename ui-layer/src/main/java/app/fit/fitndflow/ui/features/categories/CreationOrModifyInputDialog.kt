...
import app.fit.fitndflow.ui.databinding.DialogCreationInputBinding
            ...
            when (createType) {
                TYPE_CATEGORY -> {
                    ...
                    creationDialogAddBtn.setOnClickListener {
                        ...
                        val language: String = requireContext().getString(R.string.language)
                        newCategoryTxt.accessibilityDelegate = AccessibilityUtils.createAccesibilityDelegate(language + newCategoryTxt.text.toString())
                        if(!newCategoryTxt.text.toString().isEmpty()) {
                            if (currentId != null) {
