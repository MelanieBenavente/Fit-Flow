...
object DatabaseMigrations {
    ...
    val MIGRATION_1_2: Migration = object : Migration(1, 2) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("ALTER TABLE exercises_table ADD COLUMN firstReps INTEGER NOT NULL DEFAULT 0")
            database.execSQL("ALTER TABLE exercises_table ADD COLUMN firstWeight REAL NOT NULL DEFAULT 0.0")
        }
    }
